...
HD_PWD='C:/Vivado_projects/DiTe/Vivado/DiTe_PStA_1/DiTe_PStA_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zaehler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zaehler.tcl
