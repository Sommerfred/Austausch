...
HD_PWD='C:/Vivado_projects/DiTe/Vivado/DiTe_PStA_1/DiTe_PStA_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zaehler.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zaehler.tcl -notrace
